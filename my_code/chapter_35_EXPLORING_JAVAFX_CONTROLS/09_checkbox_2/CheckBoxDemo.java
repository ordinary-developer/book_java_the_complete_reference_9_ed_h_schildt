...
public class CheckBoxDemo extends Application {
    ...
    public void start(Stage stage) {
        ...
        webCheckBox.setAllowIndeterminate(true);
        desktopCheckBox.setAllowIndeterminate(true);
        mobileCheckBox.setAllowIndeterminate(true);

        webCheckBox.setOnAction(new EventHandler<ActionEvent>() {
            public void handle(ActionEvent actionEvent) {
                if (webCheckBox.isIndeterminate()) {
                    responseLabel.setText("Web deployment is indeterminate.");
                }
                else if (webCheckBox.isSelected()) {
        ...
        desktopCheckBox.setOnAction((actionEvent) -> {
            if (desktopCheckBox.isIndeterminate()) {
                responseLabel.setText("Desktop deployment is indeterminate");
            }
            else if (desktopCheckBox.isSelected()) {
        ...
        mobileCheckBox.setOnAction((actionEvent) -> {
            if (mobileCheckBox.isIndeterminate()) {
                responseLabel.setText("Mobile deployment is indeterminate");
            }
            else if (mobileCheckBox.isSelected()) {
