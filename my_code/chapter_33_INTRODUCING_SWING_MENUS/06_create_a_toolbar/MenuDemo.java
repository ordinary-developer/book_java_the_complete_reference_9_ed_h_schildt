...
class MenuDemo implements ActionListener {
    ...
    public MenuDemo() {
        ...
        setButton.setActionCommand("Set Breakpoint");
        setButton.setToolTipText("Set Breakpoint");

        JButton clearButton = new JButton(clearIcon);
        clearButton.setActionCommand("Clear Breakpoint");
        clearButton.setToolTipText("Clear Breakpoint");
